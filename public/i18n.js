...
function getBasePath() {
    // Check multiple conditions for GitHub Pages
...
async function initLanguage() {
    try {
        ...
        // Even if language initialization fails, ensure icons are initialized
        setTimeout(() => {
...
// Wrap in try-catch to ensure window.i18n is always set, even if there are errors
try {
    window.i18n = {
        t,
        setLanguage,
    ...
    // Set a minimal i18n object to prevent errors
    window.i18n = {
        t: (key) => key,
        setLanguage: async () => {},
